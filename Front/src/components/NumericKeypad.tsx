    ...
    <div className="grid grid-cols-3 gap-3 h-full">
      ...
      {["1", "2", "3", "4", "5", "6", "7", "8", "9"].map((k) => (
        <button
          ...
          onClick={() => push(k)}
          disabled={disabled}
          className="keypad-btn h-full text-3xl font-bold bg-white hover:bg-gray-50 text-gray-800 
      ...
      <button
        onClick={onClear}
        disabled={disabled}
        className="keypad-btn keypad-btn-action h-full flex flex-col items-center justify-center
